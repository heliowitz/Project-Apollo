 ...
 * License: MIT
 */
angular.module('dndLists', ['listApp'])
   ...
   *                      - "copyMove": The user can choosell between copy and move by pressing the
   ...
   *                      his mouse pointer.
   */
  .directive('dndDraggable', ['$parse', '$timeout', 'dndDropEffectWorkaround', 'dndDragTypeWorkaround', 'userFactory',
                      function($parse,   $timeout,   dndDropEffectWorkaround,   dndDragTypeWorkaround, userFactory) {
    return function(scope, element, attr) {
      ...
      element.on('dragend', function(event) {
        ...
        console.log(userFactory.user.backlogList);
        userFactory.saveBacklogList();
        event = event.originalEvent || event;
